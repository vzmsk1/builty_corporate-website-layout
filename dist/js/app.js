(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".products-mainpage__slider")) new core(".products-mainpage__slider", {
            ...
            if (document.querySelector(".projects-mainpage__slider ")) new core(".projects-mainpage__slider ", {
                ...
                effect: "fade",
                navigation: {
                    prevEl: ".slider-control__arrow_prev",
                    nextEl: ".slider-control__arrow_next"
                },
                on: {}
            });
        }
        ...
        window.addEventListener("load", (function(e) {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                const activeElement = document.querySelector(".map-locality-mainpage__item._active");
                if (!targetElement.closest(".item-map-locality-mainpage__body")) if (targetElement.closest(".map-locality-mainpage__item")) {
                    targetElement.closest(".map-locality-mainpage__item").classList.toggle("_active");
                    if (activeElement && activeElement !== targetElement) activeElement.classList.remove("_active");
